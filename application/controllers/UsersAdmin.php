...
class UsersAdmin extends Controller
{
	        ...
	        if (isset($_POST['Id_Usuario']) & is_numeric($_POST['Id_Usuario'])) {
	        	if ($this->Usuario->getUserById($_POST['Id_Usuario'])) {
			        ...
			        if ($validation) {
						...
						//---------------mensaje para raul: mejorar la apariencia de los mensajes de informacion correcta e informacion sin cambios
						//--------lineas 218-222, 224-228,238-242
			        	switch ($success['success']) {
			        		case '-2':  //error en la base de datos
			        			$data['resultStatus'] = '<div class="row" style="background-color:#69FD5E;" font-size: 26px;">
													    <div class="col-12 text-center">
													        Error en la base de datos, intenta de nuevo
													    </div>
													</div>';
			        			break;
			        		case '-1':  //erro en el formulario
			        			$data['resultStatus'] = '<div class="row" style="background-color:#FFE57A;" font-size: 26px;">
													    <div class="col-12 text-center">
													        Error en formulario
													    </div>
													</div>';
	...
	/*Función añadida para manejar 4 bits de narrativas */
	public function generarInfoPermisosForTableNa($numBin){
		$dataReturn = '';
		$dataReturn.= '<div><span class=\'v-a-middle\'>Pet: </span>';
		if ($numBin[3] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}

		$dataReturn.= '<div><span class=\'v-a-middle\'>El: </span>';
		if ($numBin[2] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}

		$dataReturn.= '<div><span class=\'v-a-middle\'>Det: </span>';
		if ($numBin[1] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}

		$dataReturn.= '<div><span class=\'v-a-middle\'>IPH: </span>';
		if ($numBin[0] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
	...
	/*Función añadida para manejar 11 bits de permisos */
	public function generarInfoPermisosForTable11Bits($numBin){
		$dataReturn = '';
		$dataReturn.= '<div><span class=\'v-a-middle\'>DP: </span>';
		if ($numBin[10] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>PE: </span>';
		if ($numBin[9] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>UH: </span>';
		if ($numBin[8] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>EP: </span>';
		if ($numBin[7] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>OA: </span>';
		if ($numBin[6] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>CFyH: </span>';
		if ($numBin[5] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>UD: </span>';
		if ($numBin[4] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>SP: </span>';
		if ($numBin[3] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>ED: </span>';
		if ($numBin[2] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>MF: </span>';
		if ($numBin[1] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		$dataReturn.= '<div><span class=\'v-a-middle\'>N: </span>';
		if ($numBin[0] == '1') {$dataReturn.=' <i class=\'material-icons check v-a-middle\'>check</i></div>';}
		else 	{$dataReturn.=' <i class=\'material-icons myClose v-a-middle\'>close</i></div>';}
		return $dataReturn;
	}
	...
	/*Funcion añadida para manejar los cuatro bits para narrativas*/
	public function permisosToCadenaExportNarrativas($permisosArray,$letra){
		//cadenas permisos para exportación
		$aux_permisos = ($permisosArray[3])?$letra:"* ";
		$aux_permisos.= ($permisosArray[2])?$letra:"* ";
		$aux_permisos.= ($permisosArray[1])?$letra:"* ";
		$aux_permisos.= ($permisosArray[0])?$letra:"* ";
		return $aux_permisos;
	}
	/*Funcion añadida para manejar los once bits para narrativas*/
	public function permisosToCadenaExportRemisiones($permisosArray,$letra){
		//cadenas permisos para exportación
		$aux_permisos = ($permisosArray[10])?$letra:"* ";
		$aux_permisos.= ($permisosArray[9])?$letra:"* ";
		$aux_permisos.= ($permisosArray[8])?$letra:"* ";
		$aux_permisos.= ($permisosArray[7])?$letra:"* ";
		$aux_permisos.= ($permisosArray[6])?$letra:"* ";
		$aux_permisos.= ($permisosArray[5])?$letra:"* ";
		$aux_permisos.= ($permisosArray[4])?$letra:"* ";
		$aux_permisos.= ($permisosArray[3])?$letra:"* ";
		$aux_permisos.= ($permisosArray[2])?$letra:"* ";
		$aux_permisos.= ($permisosArray[1])?$letra:"* ";
		$aux_permisos.= ($permisosArray[0])?$letra:"* ";
    ...
    public function generarInfoTable($rows,$filtro = 1){
            ...
            switch ($filtro) {
                ...
                case '3': //otros
					//Se añade para mostrar permisos de editar/ver remision editar/ver narrativas
                    $infoTable['header'] .= '
                        <th class="column1">#</th>
									<th class="column2">Usuario</th>
									<th class="column3">Nombre</th>

									<th class="column4">Jurídico</th>
									<th class="column5">Dictamen M</th>
									<th class="column6">Remis</th>
									<th class="column7">Inspec</th>
									<th class="column8">Int Op</th>
									<th class="column9">IPH Final</th>
									<th class="column10">Seguim</th>
									<th class="column11">Evento D</th>
									<th class="column12">EditarRemis</th>
									<th class="column13">VerRemis</th>
									<th class="column14">EditarNarra</th>
									<th class="column15">verNarra</th>
									<th class="column16">Modo Administrador</th>
									<th class="column17">Vehiculos</th>
									<th >Editar</th>
									<th >Ver</th>
									<th >Estatus</th>
									<th >Foto</th>
                    ...
                    foreach ($rows as $user) {
						...
						$juridico = $this->generarInfoPermisosForTable($user->Juridico);
						$dictamen_m = $this->generarInfoPermisosForTable($user->Dictamen_M);
						$remisiones = $this->generarInfoPermisosForTable($user->Remisiones);
						$inspecciones = $this->generarInfoPermisosForTable($user->Inspecciones);
						$inteligencia_op = $this->generarInfoPermisosForTable($user->Inteligencia_Op);
						$iph_final = $this->generarInfoPermisosForTable($user->IPH_Final);
						$seguimientos = $this->generarInfoPermisosForTable($user->Seguimientos);
						$evento_d = $this->generarInfoPermisosForTable($user->Evento_D);
						//Se añade para mostrar permisos de editar/ver remision editar/ver narrativas
						$editar_remision = $this->generarInfoPermisosForTable11Bits($user->Editar_remisiones);
						$ver_remision = $this->generarInfoPermisosForTable11Bits($user->Ver_remisiones);
						$editar_narra = $this->generarInfoPermisosForTableNa($user->editar_Narrativas);
						$ver_narra = $this->generarInfoPermisosForTableNa($user->ver_Narrativas);
						$vehiculos = $this->generarInfoPermisosForTable($user->Vehiculos);
						//Se añade para mostrar permisos de editar/ver remision editar/ver narrativas
						$infoTable['body'].= '	
										<td class="column4">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$juridico.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column5">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$dictamen_m.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column6">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$remisiones.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column7">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$inspecciones.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column8">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$inteligencia_op.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column9">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$iph_final.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column10">
										...
										<td class="column11">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$evento_d.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column12">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$editar_remision.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column13">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$ver_remision.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column14">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$editar_narra.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
										<td class="column15">
											<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$ver_narra.'"><i class="material-icons v-a-middle">accessibility</i></button>
										</td>
				        ...
				        if($user->Modo_Admin)
				        	$infoTable['body'].= '<td class="modoDios column16">ACTIVADO</td>';
				        
				        else
				        	$infoTable['body'].= '<td class="column16">DESACTIVADO</td>';
						$infoTable['body'].= '<td class="column17">
							<button type="button" class="btn btn-opacity" data-html="true" data-title="permisos" data-toggle="popover" data-placement="top" data-trigger="focus"  data-content="'.$vehiculos.'"><i class="material-icons v-a-middle">accessibility</i></button>
						</td>';
        ...
        if ($tipo_export == 'EXCEL') {
            ...
            switch ($filtroActual) {
                ...
                case '3':
					...
					//Se actualiza para los nuevos permisos editar/ver narrativas editar/ver remisiones
					$csv_data="#,User Name,Nombre completo,Correo,Area,Jurídico,Dictamen_M,Remisiones,Inspecciones,Inteligencia_Op,IPH_Final,Seguimientos,Evento D,Vehiculos,Editar Narrativas, Ver Narrativas, Editar Remisiones, Ver Remisiones,Estatus, Modo Admin\n";
					foreach ($users as $user) {
						//cadenas permisos para exportación
						$aux_juridico = $this->permisosToCadenaExport($user->Juridico);
						$aux_dictamen = $this->permisosToCadenaExport($user->Dictamen_M);
						$aux_remisiones = $this->permisosToCadenaExport($user->Remisiones);
						$aux_inspecciones = $this->permisosToCadenaExport($user->Inspecciones);
						$aux_inteligencia_op = $this->permisosToCadenaExport($user->Inteligencia_Op);
						$aux_iph_final = $this->permisosToCadenaExport($user->IPH_Final);
						$aux_seguimientos = $this->permisosToCadenaExport($user->Seguimientos);
						$aux_evento = $this->permisosToCadenaExport($user->Evento_D);
						//Se actualiza para los nuevos permisos editar/ver narrativas editar/ver remisiones
						$aux_narrativase = $this->permisosToCadenaExportNarrativas($user->editar_Narrativas,"U");
						$aux_narrativasv = $this->permisosToCadenaExportNarrativas($user->ver_Narrativas,"R");
						$aux_remisioneseditar = $this->permisosToCadenaExportRemisiones($user->Editar_remisiones,"U");
						$aux_remisionesver = $this->permisosToCadenaExportRemisiones($user->Ver_remisiones,"R");

						$aux_modo_admin = ($user->Modo_Admin)?"Activado":"Desactivado";
						$vehiculos = $this->permisosToCadenaExport($user->Vehiculos);
						$csv_data.= $user->Id_Usuario.",".
									...
									$aux_narrativase.",".
									$aux_narrativasv.",".
									$aux_remisioneseditar.",".
									$aux_remisionesver.",".
									($user->Estatus=='0' ? 'INACTIVO' : 'ACTIVO').",".
									$aux_modo_admin."\n";
        ...
        switch ($filtroActual) {
            ...
            case '3':
		        ...
		        foreach ($users as $key => $user) {
					...
					$users[$key]->Juridico 			= $this->permisosToCadenaExport($user->Juridico);
					$users[$key]->Dictamen_M 		= $this->permisosToCadenaExport($user->Dictamen_M);
					$users[$key]->Remisiones 		= $this->permisosToCadenaExport($user->Remisiones);
					$users[$key]->Inspecciones 		= $this->permisosToCadenaExport($user->Inspecciones);
					$users[$key]->Inteligencia_Op 	= $this->permisosToCadenaExport($user->Inteligencia_Op);
					$users[$key]->IPH_Final 		= $this->permisosToCadenaExport($user->IPH_Final);
    ...
    public function generateDropdownColumns($filtro=1){
        ...
        switch ($filtro) {
            case '1':
                $campos = ['Id usuario','Username','Nombre','Jurídico','Dictamen','Remisiones','Inteligencia','Inteligencia Op','IPH Final','Seguimientos','Eventos delictivos','Editar remisiones','Ver remisiones','Editar narrativas','Ver narrativas','Modo administrador', 'Vehiculos'];
            break;
            case '2':
                $campos = ['Id usuario','Username','Nombre','Jurídico','Dictamen','Remisiones','Inteligencia','Inteligencia Op','IPH Final','Seguimientos','Eventos delictivos','Editar remisiones','Ver remisiones','Editar narrativas','Ver narrativas','Modo administrador', 'Vehiculos'];
            break;
