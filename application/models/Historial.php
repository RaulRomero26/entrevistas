            ...
            case '7': //Consultar remisión
                $where_sentence.= " FROM historial
                    ...
                    WHERE (
                        ...
                        SUBSTRING_INDEX(historial.Descripcion,' ',1) LIKE '%".$cadena."%' OR
                        SUBSTRING_INDEX(historial.Descripcion,' ',-1) LIKE '%".$cadena."%'
                    ) AND historial.Movimiento = 6
                ";
            break;
            case '8': //Crear inspeccion
                $where_sentence.= " FROM historial
                    INNER JOIN usuario
                    ON historial.Id_Usuario = usuario.Id_Usuario
                    WHERE (
                        ...
                        SUBSTRING_INDEX(historial.Descripcion,' ',1) LIKE '%".$cadena."%' OR
                        SUBSTRING_INDEX(historial.Descripcion,' ',-1) LIKE '%".$cadena."%'
                    ) AND historial.Movimiento = 7
                ";
            break;
            case '9': //Editar inspeccion
                $where_sentence.= " FROM historial
                    INNER JOIN usuario
                    ON historial.Id_Usuario = usuario.Id_Usuario
                    WHERE (
                        ...
                        SUBSTRING_INDEX(historial.Descripcion,' ',1) LIKE '%".$cadena."%' OR
                        SUBSTRING_INDEX(historial.Descripcion,' ',-1) LIKE '%".$cadena."%'
                    ) AND historial.Movimiento = 8
                ";
            break;
            case '10': //Ver inspeccion
                $where_sentence.= " FROM historial
                    INNER JOIN usuario
                    ON historial.Id_Usuario = usuario.Id_Usuario
                    WHERE (
                        ...
                        SUBSTRING_INDEX(historial.Descripcion,' ',1) LIKE '%".$cadena."%' OR
                        SUBSTRING_INDEX(historial.Descripcion,' ',-1) LIKE '%".$cadena."%'
                    ) AND historial.Movimiento = 9
                ";
            break;
            case '11': //Consultar inspeccion
                $where_sentence.= " FROM historial
                    INNER JOIN usuario
                    ON historial.Id_Usuario = usuario.Id_Usuario
                    WHERE (
            ...
            case '14': //Ver IO
                $where_sentence.= " FROM historial
                    ...
                    WHERE (
                        ...
                        SUBSTRING_INDEX(historial.Descripcion,' ',1) LIKE '%".$cadena."%' OR
                        SUBSTRING_INDEX(historial.Descripcion,' ',-1) LIKE '%".$cadena."%'
                    ) AND historial.Movimiento = 13
                ";
            break;
            case '15': //Consultar IO
                $where_sentence.= " FROM historial
                    INNER JOIN usuario
                    ON historial.Id_Usuario = usuario.Id_Usuario
                    WHERE (
