...
class Usuario
{
        ...
        if ($id_user != null) {
            $sql = "
                    SELECT  usuario.*,
                            ...
                            EXPORT_SET(permisos.Ver_remisiones,'1','0','',11) AS Ver_remisiones,
                            EXPORT_SET(permisos.Editar_remisiones,'1','0','',11) AS Editar_remisiones,
                            EXPORT_SET(permisos.ver_Narrativas,'1','0','',4) AS ver_Narrativas,
                            EXPORT_SET(permisos.editar_Narrativas,'1','0','',4) AS editar_Narrativas,
                            EXPORT_SET(permisos.Vehiculos,'1','0','',4) AS Vehiculos,
                            permisos.Modo_Admin,
            ...
            $this->db->beginTransaction(); //inicio de transaction
                ...
                if ($sinErrorForm){
                    ...
                    if (isset($post['Modo_Admin'])) { //permisos de Admin
                        ...
                        $Juridico="";$Dictamen_M="";$Remisiones="";$Inspecciones="";$Inteligencia_Op="";$IPH_Final="";$Seguimientos="";$Evento_D="";
                        //nuevos permisos para editar/ver remisiones editar/ver narrativas
                        $Remisiones_editar="";$Remisiones_ver="";$Narrativas_editar="";$Narrativas_ver="";$vehiculos="";

                        $Juridico.= (isset($post['Ju_Create']))?'1':'0'; 
                        $Juridico.= (isset($post['Ju_Read']))?'1':'0'; 
                        $Juridico.= (isset($post['Ju_Update']))?'1':'0'; 
                        $Juridico.= (isset($post['Ju_Delete']))?'1':'0';

                        $Dictamen_M.= (isset($post['Dic_Create']))?'1':'0'; 
                        $Dictamen_M.= (isset($post['Dic_Read']))?'1':'0'; 
                        $Dictamen_M.= (isset($post['Dic_Update']))?'1':'0'; 
                        $Dictamen_M.= (isset($post['Dic_Delete']))?'1':'0';

                        $Remisiones.= (isset($post['R_Create']))?'1':'0'; 
                        $Remisiones.= (isset($post['R_Read']))?'1':'0'; 
                        $Remisiones.= (isset($post['R_Update']))?'1':'0'; 
                        $Remisiones.= (isset($post['R_Delete']))?'1':'0';

                        $Inspecciones.= (isset($post['Int_Create']))?'1':'0'; 
                        $Inspecciones.= (isset($post['Int_Read']))?'1':'0'; 
                        $Inspecciones.= (isset($post['Int_Update']))?'1':'0'; 
                        $Inspecciones.= (isset($post['Int_Delete']))?'1':'0';

                        $Inteligencia_Op.= (isset($post['IntOp_Create']))?'1':'0'; 
                        $Inteligencia_Op.= (isset($post['IntOp_Read']))?'1':'0'; 
                        $Inteligencia_Op.= (isset($post['IntOp_Update']))?'1':'0'; 
                        $Inteligencia_Op.= (isset($post['IntOp_Delete']))?'1':'0';

                        $IPH_Final.= (isset($post['IPH_Create']))?'1':'0'; 
                        $IPH_Final.= (isset($post['IPH_Read']))?'1':'0'; 
                        $IPH_Final.= (isset($post['IPH_Update']))?'1':'0'; 
                        $IPH_Final.= (isset($post['IPH_Delete']))?'1':'0';

                        $Seguimientos.= (isset($post['Corr_Create']))?'1':'0'; 
                        $Seguimientos.= (isset($post['Corr_Read']))?'1':'0'; 
                        $Seguimientos.= (isset($post['Corr_Update']))?'1':'0'; 
                        $Seguimientos.= (isset($post['Corr_Delete']))?'1':'0';

                        $Evento_D.= (isset($post['E_Create']))?'1':'0'; 
                        $Evento_D.= (isset($post['E_Read']))?'1':'0'; 
                        $Evento_D.= (isset($post['E_Update']))?'1':'0'; 
                        $Evento_D.= (isset($post['E_Delete']))?'1':'0';
                        
                        $vehiculos.= (isset($post['V_Create']))?'1':'0'; 
                        $vehiculos.= (isset($post['V_Read']))?'1':'0'; 
                        $vehiculos.= (isset($post['V_Update']))?'1':'0'; 
                        $vehiculos.= (isset($post['V_Delete']))?'1':'0';
                        //nuevos permisos para editar/ver remisiones editar/ver narrativas
                        $Narrativas_editar.= (isset($post['check_narrap']))?'1':'0'; 
                        $Narrativas_editar.= (isset($post['elem_narrae']))?'1':'0'; 
                        $Narrativas_editar.= (isset($post['detenido_narrae']))?'1':'0'; 
                        $Narrativas_editar.= (isset($post['iph_narrae']))?'1':'0';

                        $Narrativas_ver.= (isset($post['check_narrapv']))?'1':'0'; 
                        $Narrativas_ver.= (isset($post['elem_narrav']))?'1':'0'; 
                        $Narrativas_ver.= (isset($post['detenido_narrav']))?'1':'0'; 
                        $Narrativas_ver.= (isset($post['iph_narrav']))?'1':'0';

                        $Remisiones_editar.= (isset($post['check_datosp']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['peti_edit']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['ubicacion_editar']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['elementos_rem']))?'1':'0';
                        $Remisiones_editar.= (isset($post['objetos_ae']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['fotosyh_e']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['ubicacion_de']))?'1':'0';
                        $Remisiones_editar.= (isset($post['senas_e']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['entrevistad_e']))?'1':'0'; 
                        $Remisiones_editar.= (isset($post['mediaf_e']))?'1':'0';
                        $Remisiones_editar.= (isset($post['narrativas_e']))?'1':'0';  

                        $Remisiones_ver.= (isset($post['check_datospv']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['peti_ver']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['ubicacion_ver']))?'1':'0';
                        $Remisiones_ver.= (isset($post['elementos_remv']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['objetos_av']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['fotosyh_v']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['ubicacion_dv']))?'1':'0';
                        $Remisiones_ver.= (isset($post['senas_v']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['entrevistad_v']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['mediaf_v']))?'1':'0'; 
                        $Remisiones_ver.= (isset($post['narrativas_v']))?'1':'0'; 

                        $this->db->query("  SELECT  Id_Permisos 
                                            FROM    permisos 
                                            WHERE   Juridico = b'".$Juridico."' AND 
                                                    Dictamen_M = b'".$Dictamen_M."' AND
                                                    Remisiones = b'".$Remisiones."' AND
                                                    Inspecciones = b'".$Inspecciones."' AND
                                                    Inteligencia_Op = b'".$Inteligencia_Op."' AND
                                                    IPH_Final = b'".$IPH_Final."' AND
                                                    Seguimientos = b'".$Seguimientos."' AND 
                                                    Evento_D = b'".$Evento_D."' AND 
                                                    Editar_remisiones = b'".$Remisiones_editar."' AND 
                                                    Ver_remisiones = b'".$Remisiones_ver."' AND 
                                                    editar_Narrativas = b'".$Narrativas_editar."' AND 
                                                    ver_Narrativas = b'".$Narrativas_ver."' AND 
                                                    Vehiculos = b'".$vehiculos."' AND
                                                    Modo_Admin = 0");
                        ...
                        if ($Permisos) {
                            ...
                            //se modifica este para ingresar nuevos permisos
                            //se modifica este para ingresar nuevos permisos
                            $this->db->query("INSERT INTO   permisos (Juridico,Dictamen_M,Remisiones,Inspecciones,Inteligencia_Op,IPH_Final,Seguimientos,Evento_D,editar_Narrativas,ver_Narrativas,Editar_remisiones,Ver_remisiones,Vehiculos)  
                                                            VALUES (    b'".$Juridico."',
                                                                        b'".$Dictamen_M."',
                                                                        b'".$Remisiones."',
                                                                        b'".$Inspecciones."',
    ...
    /*Se actualiza con los nuevos permisos para editar/ver remisiones editar/ver narrativas */
                ...
                $this->db->beginTransaction(); //inicio de transaction
                    ...
                    if ($sinErrorForm) {
                        ...
                        elseif (($Modo_Admin_Now != $dataBefore['Modo_Admin']) && ($Modo_Admin_Now == 0)) { //se cambian los otros permisos
                            ...
                            /*Campos nuevos añadidos para editar/ver remisiones editar/ver narrativas*/
                            ...
                            if ($Permisos) {
                                ...
                                $this->db->query("INSERT INTO   permisos 
                                                                (Juridico,Dictamen_M,Remisiones,Inspecciones,Inteligencia_Op,IPH_Final,Seguimientos,Evento_D,editar_Narrativas,ver_Narrativas,Editar_remisiones,Ver_remisiones, Vehiculos) 
                                                                VALUES (    b'".$Juridico."',
                                                                            b'".$Dictamen_M."',
                                                                            b'".$Remisiones."',
                                                                            b'".$Inspecciones."',
                        ...
                        elseif(($Modo_Admin_Now == $dataBefore['Modo_Admin']) && ($Modo_Admin_Now == 0)){ //No cambio el modo Dios pero puede que si los deás permisos
                            ...
                            if (($Juridico != $dataBefore['Juridico']) || 
                                ($Dictamen_M != $dataBefore['Dictamen_M']) || 
                                ($Remisiones != $dataBefore['Remisiones']) || 
                                ($Inspecciones != $dataBefore['Inspecciones']) || 
                                ($Inteligencia_Op != $dataBefore['Inteligencia_Op']) || 
                                ($IPH_Final != $dataBefore['IPH_Final']) || 
                                ($Seguimientos != $dataBefore['Seguimientos']) || 
                                ($Evento_D != $dataBefore['Evento_D'])|| 
                                ($Narrativas_editar != $dataBefore['editar_Narrativas'])|| 
                                ($Narrativas_ver != $dataBefore['ver_Narrativas'])|| 
                                ($Remisiones_editar != $dataBefore['Editar_remisiones'])|| 
                                ($vehiculos != $dataBefore['Vehiculos'])|| 
                                ($Remisiones_ver != $dataBefore['Ver_remisiones'])) {
