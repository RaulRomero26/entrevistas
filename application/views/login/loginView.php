            ...
            <div class="row form">
                <div class=" col-lg-12 mt-n3">
                    <div class="text-center">
                        <img src="<?php echo base_url; ?>public/media/images/logo21.png" class="mt-4 mb-3">
                        <h5 class="card-title mb-5 mt-3 col-12">Sistema Avanzado para el Registro y Administración de Inteligencia</h5>
