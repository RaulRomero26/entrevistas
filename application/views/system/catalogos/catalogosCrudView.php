			...
			<h3 class="myDisplay">
				<?php
					switch ($data['catalogoActual']) {
						case '1': echo "Catálogo de Tatuajes"; break;
						case '2': echo "Catálogo de Instituciones de Seguridad"; break;
						case '3': echo "Catálogo de Tipos de Medida de Drogas"; break;
						case '4': echo "Catálogo de Delitos / Faltas Administrativas"; break;
						case '5': echo "Catálogo de Armas (tipos)"; break;
						case '6': echo "Catálogo de Grupos Delictivos"; break;
						case '7': echo "Catálogo de Media Filiación"; break;
						case '8': echo "Catálogo de Vehículos OCRA"; break;
						case '9': echo "Catálogo de Motocicletas"; break;
						case '10': echo "Catálogo de Escolaridad"; break;
						case '11': echo "Catálogo de Parentesco"; break;
						case '12': echo "Catálogo de Formas de Detención"; break;
						case '13': echo "Catálogo de Tipos de Violencia"; break;
						case '14': echo "Catálogo de Grupos (policías)"; break;
						case '15': echo "Catálogo de Adicciones (narcóticos)"; break;
						case '16': echo "Catálogo de tipos de Accesorios"; break;
						case '17': echo "Catálogo de tipos de Vestimenta"; break;
						case '18': echo "Catálogo de zonas y sectores"; break;
						case '19': echo "Catálogo de origen del evento"; break;
						case '20': echo "Catálogo de vectores"; break;
						case '21': echo "Catálogo del uso de vehículo"; break;
						case '22': echo "Catálogo de marca del vehículo"; break;
						case '23': echo "Catálogo de grupos de inspecciones"; break;
						//se añaden los dos nuevos catalogos: tipos y submarcas de vehiculos
						case '24': echo "Catálogo de tipos de vehiculos"; break;
						case '25': echo "Catálogo de submarcas de vehiculos"; break;
						//Se añade el catalogo para estados, municipios, calles, colonias, animales, tipo_placanip,codigos postales,cuervo personas y vehiculos
						case '26': echo "Catálogo de tipos de placas/nivs"; break;
						case '27': echo "Catálogo de tipos de animales"; break;
						case '28': echo "Catálogo de colonias"; break;
						case '29': echo "Catálogo de calles"; break;
						case '30': echo "Catálogo de estados"; break;
						case '31': echo "Catálogo de municipios"; break;
						case '32': echo "Catálogo Cuervo Personas"; break;
						case '33': echo "Catálogo Cuervo Vehiculos"; break;
						case '34': echo "Catálogo Codigos Postales"; break;
					}
				?>
