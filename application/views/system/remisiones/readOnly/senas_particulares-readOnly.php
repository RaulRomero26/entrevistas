<div class="container">
    ...
    <div class="form-row mt-5">
        ...
        <div id="body" class="col-sm-3 col-12">
            <div id="front" class="body-front">
                <svg id="head" class="head" id="Front" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.32 27.55">
            ...
            <div id="back" class="body-back">
                <svg id="nape"  class="nape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.28 26.24">
        ...
        <div class="col-sm-9 col-12 content-senas">
            <h5 class="text-center mt-5">Señas particulares</h5>
            <div class="table-responsive">
                <table class="table mt-3" id="senas">
            ...
            <div class="form-row mt-5">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <span class="span_rem_ans" name="tipoVestimenta" id="tipoVestimenta"></span>
                </div>
                <div class="form-group col-sm-8">
                    <label for="descripcionVestimenta" class="label-form">Descripción:</label>
                    <span class="span_rem_ans" name="descripcionVestimenta" id="descripcionVestimenta"></span>
                </div>
            </div>
            <div class="mt-5">
                <h5 class="text-center mt-5">Accesorios</h5>
                <div class="table-responsive">
                    <table class="table mt-3" id="accesorios">
                        <thead class="thead-dark">
                            <tr>
