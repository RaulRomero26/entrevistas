<div class="container">
    <form id="data_senasParticulares" onsubmit="event.preventDefault();">
        <div class="row mt-5">
            <div class="col-12 my-4" id="msg_senasParticulares"></div>
            <?php
            ...
            <input type="hidden" name="no_remision_peticionario" id="no_remision_senasParticulares" value=<?=$no_remision?>>
            <input type="hidden" name="no_ficha_peticionario" id="no_ficha_senasParticulares" value=<?=$no_ficha?>>
            ...
            <div class="col-sm-9 col-12 mt-5 content-senas">
                ...
                <div class="form-row">
                    ...
                    <div id="descripcionsenas" class="form-group col-sm-3">
                        ...
                        <textarea class="form-control form-control-sm text-uppercase" id="descripcion" rows="2" maxlength="5000"></textarea>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="senas">
                ...
                <div class="form-row mt-5">
                    <h5 class="col-lg-12 mb-3">Vestimenta</h5>
                    <div class="form-group col-lg-4">
                        <label for="tipoVestimenta" class="label-form">Tipo de vestimenta:</label>
                        <select class="custom-select custom-select-sm" name="tipoVestimenta" id="tipoVestimenta">
                            <option value="" selected disabled>SELECCIONE UN TIPO DE VESTIMENTA</option>
                            <?php foreach ($data['senasParticulares']['vestimenta'] as $item) : ?>
                                <option value="<?php echo $item->Tipo_Vestimenta ?>"><?php echo $item->Tipo_Vestimenta ?></option>
                            <?php endforeach ?>
                        </select>
                        <span class="span_error" id="tipoVestimenta_error"></span>
                    </div>
                    <div class="form-group col-sm-8">
                        <label for="descripcionVestimenta" class="label-form">Descripción:</label>
                        <textarea  rows="2" maxlength="5000" class="form-control form-control-sm text-uppercase" name="descripcionVestimenta" id="descripcionVestimenta"></textarea>
                        <span class="span_error" id="descripcionVestimenta_error"></span>
                    </div>
                </div>
                <div class="mt-5">
                    <div class="alert alert-warning" role="alert" id="alertEditAccesorio">
                        Está realizando edición a un elemento.
                    </div>
                    <span class="span_error" id="inputsAccesorio_error"></span>
                    <div class="form-row">
                        <div class="form-group col-lg-4">
                            <label for="tipoAccesorio" class="label-form">Tipo de accesorio:</label>
                            <select class="custom-select custom-select-sm" name="tipoAccesorio" id="tipoAccesorio">
                                <option value="" selected disabled>SELECCIONE UN TIPO DE ACCESORIO</option>
                                <?php foreach ($data['senasParticulares']['accesorios'] as $item) : ?>
                                    <option value="<?php echo $item->Tipo_Accesorio ?>"><?php echo $item->Tipo_Accesorio ?></option>
                                <?php endforeach ?>
                            </select>
                            <div class="invalid-feedback" id="tipoAccesorio-invalid">
                                Seleccione un accesorio.
                            </div>
                        </div>
                        <div class="form-group col-sm-7">
                            <label for="descripcionAccesorio" class="label-form">Descripción:</label>
                            <textarea  rows="2" maxlength="6000" class="form-control form-control-sm text-uppercase" name="descripcionAccesorio" id="descripcionAccesorio"></textarea>
                            <div class="invalid-feedback" id="descripcionAccesorio-invalid">
                                La descripción es requerida.
                            </div>
                        </div>
                        <div class="col-lg-1 d-flex align-items-center">
                            <button type="button" class="btn btn-primary button-movil-plus" onclick="onFormAccesorioSubmit()">+</button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="accesorios">
                            <thead class="thead-dark">
                                <tr>
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-12 d-flex justify-content-between col-sm-12">
                <a class="btn btn-sm btn-ssc btn-tab-getIndex" data-id="7" id="btn-tab-getIndex-7" message="msg_senasParticulares">Validar</a>
                <div>
                    <a class="btn btn-sm btn-ssc" id="btn_senasParticulares">Guardar</a>
                    <span class="advise-span text-center ml-2 mt-2 span-message" id="span-message-7">* Lo sentimos, el tab ha sido validado. Su usuario no tiene los permisos necesarios para editar</span>
                </div>
            </div>
        </div>
    </form>
