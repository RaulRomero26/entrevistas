    ...
    <form id='datos_principales' onsubmit="event.preventDefault()">
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-sm-12 d-flex justify-content-start align-items-center">
                ...
                <span class="span_rem_ans" name="oficio_principales">-</span>
            </div>
            ...
            <div class="col-lg-3 col-sm-12 d-flex justify-content-end align-items-center">
                ...
                <input type="date" name="fecha_principales" id="fecha_principales" class="form-control custom-input_dt fecha" value="<?php echo date('Y-m-d') ?>">
                <span class="span_error" id="fechaP_error"></span>
            </div>

            <div class="col-lg-3 col-sm-12 d-flex justify-content-end align-items-center">
                <span class="span_rem">Hora:</span>
                <input type="time" name="hora_principales" id="hora_principales" class="form-control custom-input_dt hora" value="<?php echo date('H:i') ?>">
        ...
        <div class="form-row mt-5">
            ...
            <!--<div class="form-group col-lg-4">
                <label for="procedencia_principales" class="label-form">Procedencia:</label>
            ...
            <div class="form-group col-lg-4">
                ...
                <div class="form-group col-lg-12">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="nacionalidad_mexicana_nueva" data-id="principales" name="nacionalidad_nueva" class="custom-control-input" value="MEXICANA" CHECKED>
                        <label class="custom-control-label label-form" for="nacionalidad_mexicana_nueva">Mexicana</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="nacionalidad_extranjera_nueva" data-id="principales" name="nacionalidad_nueva" class="custom-control-input" value="EXTRANJERA">
                        <label class="custom-control-label label-form" for="nacionalidad_extranjera_nueva">Extranjera</label>
                    </div>
                </div>
            </div>
            <div class="form-group col-lg-4" id="estado_nacimiento_nueva">
                <label for="procedencia_estado_principales_nueva" class="label-form">Estado de nacimiento:</label>
                <select class="custom-select custom-select-sm" id="procedencia_estado_principales_nueva" name="procedencia_estado_principales_nueva">
                    <?php foreach ($data['datos_prim']['estados'] as $item) : ?>
                        <option value="<?php echo $item->Estado ?>"<?php if($item->Estado=="PUEBLA") echo "selected";?> ><?php echo $item->Estado ?></option>
                    <?php endforeach ?>
                </select>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="domicilio_foraneo" data-id="principales" name="busqueda_puebla" class="custom-control-input" value="FARANEO">
                    ...
                    <div class="form-group col-lg-12">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="porDireccion" name="busqueda" class="custom-control-input" value="0">
                            <label class="custom-control-label label-form" for="porDireccion">Dirección</label>
                        </div>

                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="porCoordenadas" name="busqueda" class="custom-control-input" value="1">
                    ...
                    <div class="form-group col-lg-12 mi_hide" id="por_coordenadas">
                        <div class="input-group input-group-sm">
                            ...
                            <button class="btn btn-ssc btn-sm" id="buscar_ev">Buscar</button>
                        </div>
                    </div>
        ...
        <div class="form-row mt-5">
            ...
            <div class="form-group col-lg-12">
                ...
                <textarea class="form-control text-uppercase" id="pertenencias_rem" name="pertenencias_rem" rows="6" maxlength="200"></textarea>
        ...
        <div class="row mt-5 mb-5">
            <div class="d-flex justify-content-end col-sm-12" id="id_p">
                <a class="btn btn-sm btn-ssc mr-3" href="<?= base_url; ?>Remisiones">Volver al inicio</a>
