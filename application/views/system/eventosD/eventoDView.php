...
<div class="container mt-5 mb-3">
	<div class="row">
		<div class="col-auto mr-auto my-auto">
			<h5 class="title-width my-auto">Eventos delictivos</h5>
		</div>
		<div class="col-auto my-auto">
			<a class="btn btn-opacity" href="<?= base_url;?>EventosDelictivos/nuevoEventoD" >Nuevo Evento Delictivo</a>
		</div>
	</div>
	
	<div class="row mt-5">
		<div class="col-lg-12" id="message_index">
		</div>
		<div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto  d-flex justify-content-center">
			...
			<div class="dropdown-menu" aria-labelledby="id_filtros">
				...
				<a class="dropdown-item <?= ($data['filtroActual']==1)?'active':'';?>" href="<?= base_url;?>EventosDelictivos/index/?filtro=1">Vista general</a>
				<a class="dropdown-item <?= ($data['filtroActual']==2)?'active':'';?>" href="<?= base_url;?>EventosDelictivos/index/?filtro=2">Con Detenidos</a>
				<a class="dropdown-item <?= ($data['filtroActual']==3)?'active':'';?>" href="<?= base_url;?>EventosDelictivos/index/?filtro=3">Sin Detenidos</a>
		...
		<div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto d-flex justify-content-center">
			<div class="row">
				<div id="buttonsExport" class="col-12">
					...
					<a id="id_link_excel" href="<?= base_url ?>EventosDelictivos/exportarInfo/?tipo_export=<?= "EXCEL".$cadenaExport.$filtroActual; ?>" class="btn" data-toggle="tooltip" data-placement="bottom" title="Exportar a Excel">
	...
	<div class="row d-flex justify-content-center mt-3">
		<div class="col-auto">
			...
			<div class="chip">
				<span class="v-a-middle" >
					<?php
						if (isset($_SESSION['userdata']->rango_inicio_ed)) {
							$r_inicio = $_SESSION['userdata']->rango_inicio_ed;
							$r_fin = $_SESSION['userdata']->rango_fin_ed;
		...
		<?php
			if (isset($_SESSION['userdata']->rango_inicio_ed)) {
				?>
					<a class="btn btn-opacity" href="<?= base_url;?>EventosDelictivos/removeRangosFechasSesion/?filtroActual=<?= $data['filtroActual'];?>">mostrar todo</a>
				<?php
			}
		?>
	</div>	
	...
	<div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
		    ...
		    <div class="modal-body">
		        <div class="container">
		        	<form id="form_rangos" class="row filter-content mb-3" method="post" action="<?= base_url;?>EventosDelictivos/index/?filtro=<?= $data['filtroActual']?>">
		        		<div class="col-3">
