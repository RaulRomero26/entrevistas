<div class="container">
    ...
    <div class="container mt-4 mb-3 ">
        <div class="col-12 text-left">
            <h4 class="display-5">Editar seguimiento a vehículo</h5>
        </div>
    </div>
    ...
    <div class="form-row mt-5">
        <form id="datos_editarSV" class="col-12" method="post" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="event.preventDefault();">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        <label for="svcelulas" class="label-form">Célula de seguimiento:</label>
                ...
                <div class="col-12 d-flex justify-content-center col-sm-12">
                    <button type="submit" id="editarSV" class="btn btn-sm btn-ssc" name="editarSV">Guardar</button>
                </div>
        </form>
    </div>
</div>
