    <div class="container">
        ...
        <div class="container mt-4 mb-3 ">
            <div class="row">
                <div class="col-12 text-left">
                    <h4 class="display-5">Nuevo seguimiento a persona</h5>
                </div>
            </div>
        </div>
        ...
        <div class="form-row mt-5">
            ...
            <form id="datos_nuevoSP" class="col-12" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="event.preventDefault();">
                <div class="col-12 my-4" id="msg_seguimientoPersona"></div>
                    <div class="row">
                        <div class="form-group col-lg-4">
                            <label for="spnofolio911" class="label-form">No. Folio 911: </label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnofolio911" name="spnofolio911">
                            <span class="span_error" id="No_folio911_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spfolioinfra" class="label-form">Folio Infra: </label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spfolioinfra" name="spfolioinfra">
                            <span class="span_error" id="No_folioinfra_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spcelulas" class="label-form">Célula del Seguimiento:</label>
                            <select class="custom-select custom-select-sm" id="spcelulas" name="spcelulas">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnombre1" name="spnombre1">            
                            <span class="span_error" id="spnombre1_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spnombre2" class="label-form">Nombre #2:</label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnombre2" name="spnombre2">            
                            <span class="span_error" id="spnombre2_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spnombre3" class="label-form">Nombre #3:</label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnombre3" name="spnombre3">
                            <span class="span_error" id="spnombre3_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spappater" name="spappater">
                            <span class="span_error" id="spappater_error"></span>
                        </div>

                        <div class="form-group col-lg-6">
                            <label for="spapmater" class="label-form">Apellido Materno:</label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spapmater" name="spapmater">
                            <span class="span_error" id="spapmater_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <div class="form-group col-lg-11">
                                <textarea class="form-control text-uppercase" id="spotrosnomf" name="spotrosnomf" rows="4" placeholder="SEPARE CADA NOMBRE FALSO CON UNA COMA ','"></textarea>
                            </div>
                            <span class="span_error" id="spotrosnomf_error"></span>
                        </div>

                        <div class="form-group col-lg-6">
                            <label for="spalias" class="label-form">Alias:</label>
                            <div class="form-group col-lg-11">
                                <textarea class="form-control text-uppercase" id="spalias" name="spalias" rows="4" placeholder="SEPARE CADA ALIAS CON UNA COMA ','"></textarea>
                            </div>
                            <span class="span_error" id="spalias_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="date" class="form-control form-control-sm" id="spfechand" name="spfechand">
                            <span class="span_error" id="spfechand_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spedad" class="label-form">Edad:</label>
                            <input type="text" class="form-control form-control-sm" id="spedad" name="spedad" maxlength="2" onkeypress="return soloNumeros(event)">
                            <span class="span_error" id="spedad_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="splugaro" class="label-form">Lugar de Origen:</label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="splugaro" name="splugaro">            
                            <span class="span_error" id="splugaro_error"></span>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-row mt-3">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div id="select-coordenadas" class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="spdomicilio_colonia" name="spdomicilio_colonia">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="spdomicilio_calle" name="spdomicilio_calle">
                                    <span class="span_error" id="spdomicilio_calle_error"></span>

                                </div>

                                <div class="form-group col-lg-3">
                                    <label for="spdomicilio_numint" class="label-form">No. de Interior:</label>
                                    <input type="text" class="form-control form-control-sm" id="spdomicilio_numint" name="spdomicilio_numint">
                                </div>

                                <div class="form-group col-lg-3">
                                    <label for="spdomicilio_numext" class="label-form">No. de Exterior:</label>
                                    <input type="text" class="form-control form-control-sm" id="spdomicilio_numext" name="spdomicilio_numext">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="spdomicilio_cp" name="spdomicilio_cp">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control form-control-sm" id="sptel" name="sptel">            
                            <span class="span_error" id="sptel_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spocupacion" class="label-form">Ocupación: </label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spocupacion" name="spocupacion">           
                            <span class="span_error" id="spocupacion_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="spredsocial" class="label-form">Red Social: </label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spredsocial" name="spredsocial">            
                            <span class="span_error" id="spredsocial_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnombrefamc" name="spnombrefamc">            
                            <span class="span_error" id="spnombrefamc_error"></span>
                        </div>

                        <div class="form-group col-lg-6">
                            <label for="spparentezco" class="label-form">Parentesco: </label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spparentezco" name="spparentezco">            
                            <span class="span_error" id="spparentezco_error"></span>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-lg-2" id="btn_img">
                            ...
                            <div class="d-flex justify-content-around">
                                <div class="form-group">
                                    <input type="file" name="fileSeguimiento" accept="image/*" id="fileSeguimiento" class="inputfile uploadFileSeguimiento" onchange="uploadFile(event)" data-toggle="tooltip" data-placement="bottom">
                                    <label for="fileSeguimiento">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spvinculodel" name="spvinculodel">
                            <span class="span_error" id="spvinculodel_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12">
                                <textarea class="form-control text-uppercase" id="spmodusoperandi" name="spmodusoperandi" rows="12"></textarea>
                            </div>
                            <span class="span_error" id="spmodusoperandi_error"></span>
                        </div>
                    </div>
    <!--
                    <div class="form-group col-lg-6">
    ...
    -->
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spnumcdi" name="spnumcdi">
                            <span class="span_error" id="spnumcdi_error"></span>
                        </div>

                        <div class="form-group col-lg-4">
                            <label for="sppdfcdi" class="label-form">PDF de CDI:</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" onchange="uploadFileCDI(event)" id="sppdfcdi" name="sppdfcdi" accept=".pdf" aria-describedby="pdfdecdi">
                                <label class="custom-file-label" for="sppdfcdi">Buscar Archivo</label>
                            </div>
                        </div>
                        <div class="form-group col-lg-4">
    ...
    -->
                    <div class="row">
                        <div class="form-group col-lg-3">
                            ...
                            <div id="spviolencia">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="spviolencia" id="spviolencia" value="1" checked>
                                    <label class="form-check-label" for="spsi">Sí</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="spviolencia" id="spviolencia" value="0">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <select class="custom-select custom-select-sm" id="sptipov" name="sptipov">
                                <option selected>SELECCIONE</option>
                                <option value="NO APLICA">NO APLICA</option>
                                <option value="FÍSICA">FÍSICA</option>
                                <option value="ARMA DE FUEGO">ARMA DE FUEGO</option>
                                <option value="ARMA BLANCA">ARMA BLANCA</option>
                                <option value="ARMA CONTUNDENTE">ARMA CONTUNDENTE</option>
                            </select>
                        </div>

                        <div class="form-group col-lg-3">
                            <label for="spdv" class="label-form">Delito Vinculado:</label>
                            <select class="custom-select custom-select-sm" id="spdv" name="spdv">
                                <option selected>SELECCIONE</option>
                                <option value="NO APLICA">NO APLICA</option>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="spespdd" name="spespdd" onkeypress="return letrasyEspacios(event)">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <select class="custom-select custom-select-sm" id="sppado" name="sppado">
                                <option selected>SELECCIONE</option>
                                <option value="NO APLICA">NO APLICA</option>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="sppadr" name="sppadr" onkeypress="return letrasyEspacios(event)">
                        </div>
                    </div>
                    ...
                    <div class="form-row mt-5">
                        ...
                        <div class="form-row mt-5">
                            <div class="alert alert-warning col-lg-12" role="alert" id="alertEditVehiculoSP">
                                Está realizando edición a un vehículo.
                            </div>
                            <div class="form-group col-lg-3">
                            ...
                            <div class="col-lg-1 d-flex align-items-center">
                                <button type="button" onclick="onFormSegVehiculosSubmit()" class="btn btn-primary button-movil-plus">+</button>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div id="body" class="col-sm-3 col-12 mb-5">
                                <div id="front" class="body-front">
                                    <svg onclick="clickPiece('head','ROSTRO')" id="head" class="head" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.32 27.55">
                                    ...
                                    <svg onclick="clickPiece('neck','CUELLO')" id="neck" class="neck" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.65 20.98">
                                    ...
                                    <svg onclick="clickPiece('chest-right','PECTORAL DERECHO')" id="chest-right" class="chest-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.85 19.84">
                                    ...
                                    <svg onclick="clickPiece('chest-left','PECTORAL IZQUIERDO')" id="chest-left" class="chest-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.85 19.84">
                                    ...
                                    <svg onclick="clickPiece('shoulder-right','HOMBRO DERECHO')" id="shoulder-right" class="shoulder-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.87 20.04">
                                    ...
                                    <svg onclick="clickPiece('shoulder-left','HOMBRO IZQUIERDO')" id="shoulder-left" class="shoulder-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.87 20.04">
                                    ...
                                    <svg onclick="clickPiece('arm-right','BRAZO DERECHO')" id="arm-right" class="arm-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.71 27.59">
                                    ...
                                    <svg onclick="clickPiece('arm-left','BRAZO IZQUIERDO')" id="arm-left" class="arm-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.71 27.59">
                                    ...
                                    <svg onclick="clickPiece('forearm-right','ANTE-BRAZO DERECHO')" id="forearm-right" class="forearm-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.46 35.76">
                                    ...
                                    <svg onclick="clickPiece('forearm-left','ANTE-BRAZO IZQUIERDO')" id="forearm-left" class="forearm-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.46 35.76">
                                    ...
                                    <svg onclick="clickPiece('abdomen-right','ABDOMEN DERECHO')" id="abdomen-right" class="abdomen-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.49 46">
                                    ...
                                    <svg onclick="clickPiece('abdomen-left','ABDOMEN IZQUIERDO')" id="abdomen-left" class="abdomen-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.49 46">
                                    ...
                                    <svg onclick="clickPiece('leg-right','MUSLO DERECHO')" id="leg-right" class="leg-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.76 74.91">
                                    ...
                                    <svg onclick="clickPiece('leg-left','MUSLO IZQUIERDO')" id="leg-left" class="leg-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.76 74.91">
                                    ...
                                    <svg onclick="clickPiece('hand-right','MANO DERECHA')" id="hand-right" class="hand-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10.77 35.97">
                                    ...
                                    <svg onclick="clickPiece('hand-left','MANO IZQUIERDA')" id="hand-left" class="hand-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10.77 35.97">
                                    ...
                                    <svg onclick="clickPiece('calf-right','PIERNA DERECHA')" id="calf-right" class="calf-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.39 38.21">
                                    ...
                                    <svg onclick="clickPiece('calf-left','PIERNA IZQUIERDA')" id="calf-left" class="calf-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.39 38.21">
                                    ...
                                    <svg onclick="clickPiece('foot-right','PIE DERECHO')" id="foot-right" class="foot-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.47 23.62">
                                    ...
                                    <svg onclick="clickPiece('foot-left','PIE IZQUIERDO')" id="foot-left" class="foot-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.47 23.62">
                                ...
                                <div id="back" class="body-back">
                                    <svg onclick="clickPiece('nape','NUCA')" id="nape"  class="nape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.28 26.24">
                                    ...
                                    <svg  onclick="clickPiece('trapezius-right','TRAPECIO DERECHO')" id="trapezius-right" class="trapezius-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.46 12.76">
                                        <path d="M0,.57S3.27-1.4,7.32,2c0,0,4.74,3.46,7.7,4.06s7.44,4.8,7.44,4.8-.27,2.73-9.38,1.67S.23,7.24,0,.57Z"/>
                                    </svg>
                                    <svg onclick="clickPiece('trapezius-left','TRAPECIO IZQUIERDO')" id="trapezius-left" class="trapezius-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.46 12.76">
                                    ...
                                    <svg onclick="clickPiece('trunk-right','TRONCO DERECHO')" id="trunk-right" class="trunk-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.71 68.86">
                                    ...
                                    <svg onclick="clickPiece('trunk-left','TRONCO IZQUIERDO')" id="trunk-left" class="trunk-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.46 68.86">
                                    ...
                                    <svg onclick="clickPiece('p-shoulder-right','HOMBRO DERECHO')" id="p-shoulder-right" class="p-shoulder-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.29 18.59">
                                    ...
                                    <svg onclick="clickPiece('p-shoulder-left','HOMBRO IZQUIERDO')" id="p-shoulder-left" class="p-shoulder-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.29 18.59">
                                    ...
                                    <svg onclick="clickPiece('p-arm-right','BRAZO DERECHO')" id="p-arm-right" class="p-arm-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.64 25.95">
                                    ...
                                    <svg onclick="clickPiece('p-arm-left','BRAZO IZQUIERDO')" id="p-arm-left" class="p-arm-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.64 25.95">
                                    ...
                                    <svg onclick="clickPiece('p-forearm-right','ANTE-BRAZO DERECHO')" id="p-forearm-right" class="p-forearm-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.46 37.99">
                                    ...
                                    <svg onclick="clickPiece('p-forearm-left','ANTE-BRAZO IZQUIERDO')" id="p-forearm-left" class="p-forearm-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.46 37.99">
                                    ...
                                    <svg onclick="clickPiece('gluteus-right','GLUTEO DERECHO')" id="gluteus-right" class="gluteus-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.63 30.02">
                                    ...
                                    <svg onclick="clickPiece('gluteus-left','GLUTEO IZQUIERDO')" id="gluteus-left" class="gluteus-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.63 30.02">
                                    ...
                                    <svg onclick="clickPiece('p-hand-right','MANO DERECHA')" id="p-hand-right" class="p-hand-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10.41 31.49">
                                    ...
                                    <svg onclick="clickPiece('p-hand-left','MANO IZQUIERDA')" id="p-hand-left" class="p-hand-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10.41 31.49">
                                    ...
                                    <svg onclick="clickPiece('p-leg-right','MUSLO DERECHO')" id="p-leg-right" class="p-leg-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.52 57.57">
                                    ...
                                    <svg onclick="clickPiece('p-leg-left','MUSLO IZQUIERDO')" id="p-leg-left" class="p-leg-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.52 57.57">
                                    ...
                                    <svg onclick="clickPiece('p-calf-right','PIERNA DERECHA')" id="p-calf-right" class="p-calf-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.98 48.09">
                                    ...
                                    <svg onclick="clickPiece('p-calf-left','PIERNA IZQUIERDA')" id="p-calf-left" class="p-calf-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.98 48.09">
                                    ...
                                    <svg onclick="clickPiece('p-foot-right','PIE DERECHO')" id="p-foot-right" class="p-foot-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.69 18.61">
                                    ...
                                    <svg onclick="clickPiece('p-foot-left','PIE IZQUIERDO')" id="p-foot-left" class="p-foot-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.69 18.61">
                                    ...
                                    <svg onclick="clickPiece('heel-right','TALON DERECHO')" id="heel-right" class="heel-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.69 18.61">
                                    ...
                                    <svg onclick="clickPiece('heel-left','TALON IZQUIERDO')" id="heel-left" class="heel-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.69 18.61">
                            ...
                            <div class="col-sm-9 col-12 mt-5 content-senas">
                                <div class="alert alert-warning" role="alert" id="alertEditSena">
                                    Está realizando edición a un elemento.
                                </div>
                                <span class="span_error" id="inputsSenas_error"></span>
                                <div class="form-row">
                                    <div class="form-group col-lg-3">
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <label class="label-form">Parte seleccionada:</label>
                                            </div>
                                            ...
                                            <div class="form-group col-lg-12">
                                                <div class="invalid-feedback" id="list-invalid">
                                    ...
                                    <div class="form-group col-lg-2">
                                        <label for="senasparticulares" class="label-form">Tipo:</label>
                                        <select class="custom-select custom-select-sm" id="senasparticulares" onchange="selectSena()">
                                            <option value="" selected disabled>SELECCIONE UN TIPO DE SEÑA</option>
                                            <option value="TATUAJES">TATUAJES</option>
                                            <option value="CICATRICES">CICATRICES</option>
                                            <option value="LUNARES, MANCHAS Y/O VERRUGAS">LUNARES, MANCHAS Y/O VERRUGAS</option>
                                            <option value="PERFORACIONES">PERFORACIONES</option>
                                            <option value="MUTILACIONES/MALFORMACIONES">MUTILACIONES/MALFORMACIONES</option>
                                        </select>
                                        <div class="invalid-feedback" id="senasparticulares-invalid">
                                            El tipo es requerido.
                                        </div>
                                    </div>
                                    <div id="tatuajes" class="col-lg-3">
                                        <div class="row">
                                            <div class="form-group form-check col-lg-4 mt-2">
                                                <label class="form-check-label ml-2" for="colorTatuaje">Color:</label>
                                                <input class="ml-3" type="checkbox" class="form-check-input" id="colorTatuaje">
                                            </div>
                                            <div class="form-group col-lg-8">
                                                <label for="clasificacion" class="label-form">Clasificación:</label>
                                                <select class="custom-select custom-select-sm" id="clasificacion">
                                                    <option value="" selected disabled>SELECCIONE LA CLASIFICACIÓN</option>
                                                    <?php foreach ($data['senasParticulares']['tatuajes'] as $item) : ?>
                                                        <option value="<?php echo $item->Tipo_Tatuaje ?>"><?php echo $item->Tipo_Tatuaje ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                                <div class="invalid-feedback" id="clasificacion-invalid">
                                                    La clasificación es requerida.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="descripcionsenas" class="form-group col-sm-3">
                                        <label for="descripcion" class="label-form">Descripción:</label>
                                        <input type="text" class="form-control form-control-sm text-uppercase" id="descripcion">
                                        <div class="invalid-feedback" id="descripcion-invalid">
                                            La descripción es requerida.
                                        </div>
                                    </div>
                                    <div class="col-lg-1 d-flex align-items-center">
                                        <button type="button" class="btn btn-primary button-movil-plus" onclick="onFormSenasSubmit()">+</button>
                                    </div>
                                </div>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="capturePhotosenas" tabindex="-1" aria-labelledby="capturePhotosenasLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="capturePhotosenasLabel">Capturar fotografía</h6>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-sm-6" id="errMsgsenas">
                                                        <div class="video-wrap">
                                                            <video id="videosenas" playsinline autoplay></video>
                                                        </div>
                                                        <div class="text-center">
                                                            <button id="capturesenas" class="btn btn-primary">
                                                    ...
                                                    <div class="col-sm-6" id="canvas-content">
                                                        <canvas id="canvassenas" width="368" height="368"></canvas>
                                                        <div class="text-center">
                                                            <button id="add-photosenas" onclick="uploadPhoto('senas')" class="btn btn-primary" disabled>
                                                                Agregar
                                                            </button>
                                                        </div>
                                                    </div>
                    ...
                    <div class="col-12 d-flex justify-content-center col-sm-12 mt-5">
                        <button type="submit" id="crearSPid" class="btn btn-sm btn-ssc" name="crearSP">Guardar</button>
                    </div>
            </form>
        </div>
    </div>
