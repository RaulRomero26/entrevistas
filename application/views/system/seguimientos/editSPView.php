    ...
    <div class="container">
        ...
        <div class="container mt-4 mb-3 ">
            <div class="row">
                <div class="col-12 text-left">
                    <h4 class="display-5">Editar seguimiento a persona</h5>
                </div>
            </div>
        </div>
        ...
        <form id="datos_editarSP" class="col-12" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="event.preventDefault();">
            <div class="col-12 my-4" id="msg_seguimientoPersona"></div>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="hidden" id="spdomicilio_id_dom" name="spdomicilio_id_dom">
                ...
                <div class="row">
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="sptel" name="sptel" onkeypress="return soloNumeros(event)">            
                    </div>
...
-->
                ...
                <div class="row">
                    <div class="form-group col-lg-12">
                        ...
                        <div class="fileCDIResult col-sm-12 d-flex justify-content-center" id="fileCDIResult"></div>
                    </div>
                </div>    
...
-->
                <div class="row">
                    <div class="form-group col-lg-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="spviolencia" id="spviolencia_si" value="1">
                                
                                <label class="form-check-label" for="spvsi">Sí</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="spviolencia" id="spviolencia_no" value="0">
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <input type="text" class="form-control form-control-sm text-uppercase" id="spespdd" name="spespdd">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" class="form-control form-control-sm text-uppercase" id="sppadr" name="sppadr">
                    </div>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center col-sm-12 mt-5">
                    <!--<a href="" class="btn btn-sm btn-ssc">Guardar</a>-->
                    <button type="submit" id="editarSP" class="btn btn-sm btn-ssc" name="editarSP">Guardar</button>
                </div>
        </form>
        </div>
    </div>
