<div class="container">
    ...
    <form id="InteligenciaOperativaForm" onsubmit="event.preventDefault()">
        ...
        <div class="row mt-5">
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="text" class="form-control form-control-sm text-uppercase" id="Nombre_Elemento_R" name="Nombre_Elemento_R" readonly>
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="date" class="form-control form-control-sm" id="Fecha_Turno" name="Fecha_Turno">
            ...
            <div class="form-group col-lg-3">
                ...
                <input type="text" class="form-control form-control-sm" id="Caracteristicas_Robo" name="Caracteristicas_Robo">
            ...
            <div class="form-group col-lg-2 d-flex justify-content-center align-items-center" id="radio_Violencia">
            ...
            <div class="col-12 text-center mt-5 my-4">
            ...
            <div class="form-group col-lg-12">
                ...
                <input type="text" class="form-control form-control-sm" id="Unidad_Primer_R" name="Unidad_Primer_R">
    ...
    <div class="row mt-5 mb-5">
        <div class="col-12 d-flex justify-content-end col-sm-12">
            <button class="btn btn-sm btn-ssc" id="btn_Inteligencia">Actualizar</button>
        </div>
    </div>
</div>