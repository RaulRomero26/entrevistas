<?php $info_inspeccion = $data['info_inspeccion'];?>
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-auto ml-auto my-auto">
            <span class="navegacion">Folio inspección: <?= $info_inspeccion->Id_Inspeccion;?></span>
            <input type="hidden" form="id_form_insp" name="Id_Inspeccion" id="id_inspeccion" value="<?= $info_inspeccion->Id_Inspeccion;?>">
        </div>
    </div>
    <!--result alert-->
            ...
            <div class="row">
                ...
                <div class="col-auto custom-checkbox">
                    <div class="form-check">
                        <input type="checkbox" class="custom-control-input check_inspeccion" id="id_check_persona" name="Check_Persona" value="1" form="id_form_insp" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'checked':'';?>>
                ...
                <div class="col-auto custom-checkbox">
                    <div class="form-check">
                        <input type="checkbox" class="custom-control-input check_inspeccion" id="id_check_vehiculo" name="Check_Vehiculo" value="1" form="id_form_insp" <?php echo (isset($info_inspeccion->Modelo))?'checked':'';?>>
    ...
    <form id="id_form_insp" class="row" method="POST" action="<?= base_url;?>Inspecciones/editarInspeccion" enctype="multipart/form-data" accept-charset="utf-8">
        <!--INFO GENERAL-->
        <div class="col-12 ">
            <div class="row">
                ...
                <div class="form-group col-12 col-md-6 col-lg-3">
                    ...
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_quien_solicita" name="Quien_Solicita" value="<?= $info_inspeccion->Quien_Solicita?>" required>
                ...
                <div class="form-group col-12 col-md-6 col-lg-3">
                    ...
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_clave_solicitante" name="Clave_Num_Solicitante" value="<?= $info_inspeccion->Clave_Num_Solicitante?>" required>
                ...
                <div class="form-group col-12 col-md-6 col-lg-3">
                    ...
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_unidad" name="Unidad" value="<?= $info_inspeccion->Unidad?>">
                    <small id="error_unidad" class="form-text text-danger "></small>
                </div>

                <?php $auxFechaHora = explode(" ", $info_inspeccion->Fecha_Hora_Inspeccion);?>
                <div class="form-group col-12 col-md-6 col-lg-3">
                    <label for="id_fecha" class="label-form">Fecha inspección:</label>
                    <input type="date" class="form-control form-control-sm" id="id_fecha" name="Fecha_Inspeccion" value="<?= $auxFechaHora[0];?>" required>
                    <small id="error_fecha" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-md-6 col-lg-3">
                    <label for="id_hora" class="label-form">Hora inspección:</label>
                    <input type="time" class="form-control form-control-sm" id="id_hora" name="Hora_Inspeccion" value="<?= substr($auxFechaHora[1], 0, 5);?>" required>
                    <small id="error_hora" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-md-6 col-lg-3">
                    <label for="id_telefono_radio" class="label-form">Teléfono/Radio:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_telefono_radio" name="Telefono_Radio" value="<?= $info_inspeccion->Telefono_Radio?>">
                    <small id="error_telefono_radio" class="form-text text-danger "></small>
                </div>

                <!-- <div class="form-group col-12 col-md-6">
                    <label for="id_motivo" class="label-form">Motivo de la inspección:</label>
                    <textarea class="form-control text-uppercase"  id="id_motivo" name="Motivo_Inspeccion" rows="2" maxlength="1000" required><?= $info_inspeccion->Motivo_Inspeccion;?></textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row mt-3">
                                ...
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="Motivo_Radio" id="id_motivo_radio_1" value="INSPECCIÓN PREVENTIVA" <?= ($info_inspeccion->Motivo_Inspeccion == 'INSPECCIÓN PREVENTIVA')?'checked':'';?>>
                                        <label class="form-check-label" for="id_motivo_radio_1">INSPECCIÓN PREVENTIVA</label>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="Motivo_Radio" id="id_motivo_radio_2" value="OTRO" <?= ($info_inspeccion->Motivo_Inspeccion != 'INSPECCIÓN PREVENTIVA')?'checked':'';?>>
                        ...
                        <div class="col-12 <?= ($info_inspeccion->Motivo_Inspeccion != 'INSPECCIÓN PREVENTIVA')?'':'mi_hide';?>" id="id_motivo_otro_panel">
                            <div class="row mt-3">
                                <div class="col-auto my-auto">
                                    <span class="label-form">Especifique cuál: </span>
                                </div>
                                <div class="col -auto">
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_motivo_otro" name="Motivo_Otro" maxlength="1000" value="<?= ($info_inspeccion->Motivo_Inspeccion != 'INSPECCIÓN PREVENTIVA')?$info_inspeccion->Motivo_Inspeccion:'';?>">
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <textarea class="form-control text-uppercase"  id="id_resultado" name="Resultado_Inspeccion" rows="2" maxlength="1000" required><?= $info_inspeccion->Resultado_Inspeccion;?></textarea>
        ...
        <div class="col-12 col-md-6">
            <div class="row">
                <div class="col-12 text-center mt-3 mb-2">
                    <div class="text-divider">
                        <h5 class="sub_header">Persona</h5>
                    </div>
                </div>
                ...
                <div class="form-group col-12 col-lg-6">
                    ...
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_nombre" name="Nombre" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?> required>
                    <small id="error_nombre" class="form-text text-danger "></small>
                </div>

                <div class="form-group col-12 col-lg-6">
                    <label for="id_ap_paterno" class="label-form">Apellido paterno:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_ap_paterno" name="Ap_Paterno" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?> required>
                ...
                <div class="form-group col-12 col-lg-6">
                    ...
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_ap_materno" name="Ap_Materno" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?> required>
                    <small id="error_ap_materno" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-lg-6">
                    <label for="id_alias" class="label-form">Alias:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_alias" name="Alias" value="S/D" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?> required>
                ...
                <div class="form-group col-12 col-lg-6">
                    ...
                    <input type="date" class="form-control form-control-sm" id="id_fecha_nacimiento" name="Fecha_Nacimiento" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?> required>
                    <small id="error_fecha" class="form-text text-danger "></small>
                </div>
                <div class="col-12 col-lg-6 my-lg-auto my-3 text-center text-lg-left">
                    <button type="button" class="btn btn-ssc" data-toggle="tooltip" data-placement="top" title="Agregar persona" id="id_add_persona" <?php echo (isset($info_inspeccion->Nombre_Inspeccionado))?'':'disabled';?>>
                        Agregar
                    </button>
                ...
                <div class="col-12 table-responsive">
                    <table class="table table-sm table-bordered" id="id_persona_table">
                        <thead >
        ...
        <div class="col-12 col-md-6">
            <div class="row">
                ...
                <div class="form-group col-12 col-lg-4">
                    ...
                    <select class="form-control form-control-sm" id="id_tipo" name="Tipo"  required <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                        <?php foreach ($data['tipos_vehiculos'] as $item) : ?>
                            <option value="<?php echo $item->Tipo ?>"
                            <?php
                            if(isset($info_inspeccion->Marca))
                                if(mb_strtoupper($info_inspeccion->Tipo)==mb_strtoupper($item->Tipo) || strtolower($info_inspeccion->Tipo)==strtolower($item->Tipo))
                                    echo "selected";
                            ?>><?php echo $item->Tipo; ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="form-group col-12 col-lg-4">
                    <label for="id_marca" class="label-form">Marca:</label>
                    <select class="form-control form-control-sm" id="id_marca" name="Marca"  required <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                        <?php foreach ($data['marcas_vehiculos'] as $item) : ?>
                            <option value="<?php echo $item->Marca ?>"
                            <?php
                            if(isset($info_inspeccion->Marca))
                                if(mb_strtoupper($info_inspeccion->Marca)==mb_strtoupper($item->Marca) || strtolower($info_inspeccion->Marca)==strtolower($item->Marca))
                                    echo "selected";
                ...
                <div class="form-group col-12 col-lg-4">
                    ...
                    <select class="form-control form-control-sm" id="id_submarca" name="Submarca"  required <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                        <?php foreach ($data['submarcas_vehiculos'] as $item) : ?>
                            <option value="<?php echo $item->Submarca ?>"
                            <?php
                            if(isset($info_inspeccion->Marca))
                                if(mb_strtoupper($info_inspeccion->Submarca)==mb_strtoupper($item->Submarca) || strtolower($info_inspeccion->Submarca)==strtolower($item->Submarca) )
                                    echo "selected";
                            ?>><?php echo $item->Submarca ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="form-group col-12 col-lg-4">
                    <label for="id_modelo" class="label-form">Modelo:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_modelo" name="Modelo" value="<?php echo (isset($info_inspeccion->Marca))?$info_inspeccion->Modelo:'';?>" <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?> required>
                    <small id="error_modelo" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-lg-4">
                    <label for="id_placas" class="label-form">Placas:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_placas" name="Placas_Vehiculo" value="<?php echo (isset($info_inspeccion->Marca))?$info_inspeccion->Placas_Vehiculo:'';?>" <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?> required>
                    <small id="error_placas" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-lg-4">
                    <label for="id_niv_vehiculo" class="label-form">NIV:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_niv_vehiculo" name="NIV" value="<?php echo (isset($info_inspeccion->Marca))?$info_inspeccion->NIV:'';?>" <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?> >
                    <small id="error_niv_vehiculo" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12 col-lg-4">
                    <label for="id_color" class="label-form">Color:</label>
                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_color" name="Color" value="<?php echo (isset($info_inspeccion->Marca))?$info_inspeccion->Color:'';?>" <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?> >
                    <small id="error_niv_vehiculo" class="form-text text-danger "></small>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        ...
                        <div class="col-4 text-center">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Colocacion_Placa" id="id_colocacion_1" value="Original" <?php echo (isset($info_inspeccion->Colocacion_Placa) && $info_inspeccion->Colocacion_Placa == 'Original')?'checked':'';?> <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                                <label class="form-check-label" for="id_colocacion_1">Original</label>
                            </div>
                        </div>
                        <div class="col-4 text-center">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Colocacion_Placa" id="id_colocacion_2" value="Sobrepuesta" <?php echo (isset($info_inspeccion->Colocacion_Placa) && $info_inspeccion->Colocacion_Placa == 'Sobrepuesta')?'checked':'';?> <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                                <label class="form-check-label" for="id_colocacion_2">Sobrepuesta</label>
                            </div>
                        </div>
                        <div class="col-4 text-center">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Colocacion_Placa" id="id_colocacion_3" value="Apócrifa" <?php echo (isset($info_inspeccion->Colocacion_Placa) && $info_inspeccion->Colocacion_Placa == 'Apócrifa')?'checked':'';?> <?php echo (isset($info_inspeccion->Marca))?'':'disabled';?>>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="form-group col-12 col-lg-6">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control form-control-sm text-uppercase" id="id_colonia" name="Colonia" value="<?= $info_inspeccion->Colonia?>" required>
                                    <small id="error_colonia" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-6">
                                    <label for="id_calle_1" class="label-form">Calle 1:</label>
                                    <input type="text" autocomplete="off" class="form-control form-control-sm text-uppercase" id="id_calle_1" name="Calle_1" value="<?= $info_inspeccion->Calle_1?>" required>
                                    <small id="error_calle_1" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-6">
                                    <label for="id_calle_2" class="label-form">Calle 2:</label>
                                    <input type="text" autocomplete="off" class="form-control form-control-sm text-uppercase" id="id_calle_2" name="Calle_2" value="<?= $info_inspeccion->Calle_2?>" required>
                                    <small id="error_calle_2" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-3">
                                    <label for="id_no_ext" class="label-form">Núm. Exterior:</label>
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_no_ext" name="No_Ext" value="<?= $info_inspeccion->No_Ext?>" required>
                                    <small id="error_no_ext" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-3">
                                    <label for="id_no_int" class="label-form">Núm. Interior:</label>
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_no_int" name="No_Int" value="<?= $info_inspeccion->No_Int?>" required>
                                    <small id="error_no_int" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-3">
                                    <label for="id_coord_x" class="label-form">Coordenada X:</label>
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_coord_x" name="Coordenada_X" value="<?= $info_inspeccion->Coordenada_X?>" required>
                                    <small id="error_coord_x" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-3">
                                    <label for="id_coord_y" class="label-form">Coordenada Y:</label>
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_coord_y" name="Coordenada_Y" value="<?= $info_inspeccion->Coordenada_Y?>" required>
                                    <small id="error_coord_y" class="form-text text-danger "></small>
                                </div>
                                <div class="form-group col-12 col-lg-3">
                                    <label for="id_coord_y" class="label-form">Codigo Postal:</label>
                                    <input type="text" class="form-control form-control-sm text-uppercase" id="id_cp" name="id_cp" value="<?= $info_inspeccion->CP?>"required>
    ...
    <div class="row">
        ...
        <div class="col-12 mt-4 mb-5">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-auto">
                    <button class="btn btn-ssc" onclick="checkFormInspeccion(event)" id="guardar_editar">Guardar</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6" id="canvas-content">
                            ...
                            <div class="text-center">
                                <button id="add-photoInspecciones" onclick="uploadPhoto('Inspecciones')" class="btn btn-primary" disabled>
                                    Agregar
                                </button>
                            </div>
                        </div>
...
<input type="hidden" form="id_form_insp" name="Id_Ubicacion" id="id_ubicacion" value="<?= $info_inspeccion->Id_Ubicacion;?>">