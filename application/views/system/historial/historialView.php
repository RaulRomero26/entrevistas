<?php //echo var_dump($data['prueba']);?>
<div class="container mt-5 mb-3">
    <div class="row">
        <div class="col-auto mr-auto my-auto">
			<h5 class="title-width my-auto">Historial</h5>
		</div>
    </div>
		...
		<div class="col-auto">
			...
			<div class="chip">
				<span class="v-a-middle" >
					<?php
						if (isset($_SESSION['userdata']->rango_inicio_his)) {
							$r_inicio = $_SESSION['userdata']->rango_inicio_his;
							$r_fin = $_SESSION['userdata']->rango_fin_his;
