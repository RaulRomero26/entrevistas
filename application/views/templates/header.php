  ...
  <body>
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled ">
        ...
        <?php
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Remisiones[2]) {
        ?>
        <li class="container">
          <a href="<?= base_url ?>Remisiones">Remisiones</a>
        </li>
        <?php
        }
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Inspecciones[2]) {
        ?>
        <li class="container">
        ...
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Dictamen_M[2]) {
        ?>
        <li class="container">
          <a href="<?= base_url; ?>DictamenMedico">Área Médica</a>
        </li>
  
        <?php
        }
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Inteligencia_Op[2]) {
        ?>
        <li class="container">
          <a href="<?= base_url;?>InteligenciaOperativa">Inteligencia Operativa</a>
        </li>

        <?php
        }
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Juridico[2]) {
        ?>
        <li class="container">
          <a href="<?= base_url;?>Juridico">Jurídico</a>
        </li>
  
        <?php
        }
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Evento_D[2]) {
        ?>
        <li class="container">
          <a href="<?= base_url;?>EventosDelictivos">Eventos Delictivos</a>
        </li>
        ...
        <?php
        if ($_SESSION['userdata']->Modo_Admin == 1  || $_SESSION['userdata']->Vehiculos[2]) {
        ?>
        <li class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 d-flex justify-content-center align-items-center">
            <!-- <img src="<?php echo base_url; ?>public/media/images/banner.png" alt="" width="40%" class=""> -->
            <img src="<?php echo base_url; ?>public/media/images/logo21.png" width="15%" class="my-1">
          </div>
