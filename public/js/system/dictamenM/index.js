...
search_button.addEventListener('click', buscarDictamenCad)

function buscarDictamenCad(e) {
	...
	fetch(base_url_js+'DictamenMedico/buscarPorCadena', {
		method: 'POST',
		body: myform
	})
...
{	
	...
	fetch(base_url_js+'DictamenMedico/setColumnFetch', {
			method: 'POST',
			body: myform
		})
	.then(function(response){
